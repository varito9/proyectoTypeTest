CREATE TABLE datos_ejemplo (
    -- 1. Clave primaria para la fila (única)
    linea_id INT NOT NULL AUTO_INCREMENT,
    
    -- 2. Categoría de la magia (foc, foscor, gel, etc.)
    categoria VARCHAR(50) NOT NULL,
    
    -- 3. Nivel o identificador numérico de la magia (1, 2, 3...)
    mag INT NOT NULL, 
    
    -- 4. Orden de la línea dentro del conjuro (1, 2, 3...)
    linea_orden INT NOT NULL, 
    
    -- 5. Título de la magia (se repite en cada línea del conjuro)
    titol VARCHAR(255) NOT NULL, 
    
    -- 6. Texto de la línea (máximo 24 caracteres, según la petición)
    linea_texto VARCHAR(24) NOT NULL, 
    
    -- Definición de la clave primaria
    PRIMARY KEY (linea_id),
    
    -- Clave única compuesta para asegurar el orden de las líneas dentro del mismo conjuro
    UNIQUE KEY (categoria, mag, linea_orden)
);

INSERT INTO datos_ejemplo (categoria, mag, linea_orden, titol, linea_texto) VALUES
-- Foc 1 - Cor del Volcà (21 línies)
...
('foscor', 2, 20, 'Foscor 2 - El Pacte', ' l''abisme devorador.   '), -- Aquesta línia ha estat afegida per omplir a 20, ja que només n'hi havia 19 dades
-- Foscor 3 - El Vòrtex (20 línies)
...
--
INSERT INTO datos_ejemplo (categoria, mag, linea_orden, titol, linea_texto) VALUES
-- Llum 1 - Far d'Esperança (20 línies)
...
('llum', 3, 20, 'Llum 3 - Càstig Diví', 't amagar d''ella.       '); -- Aquesta línia ha estat afegida per omplir a 20, ja que només n''hi havia 19 dades

--
-- DADES DE LA CATEGORIA: gel
--
INSERT INTO datos_ejemplo (categoria, mag, linea_orden, titol, linea_texto) VALUES
-- Gel 1 - El Glaçal (20 línies)
...
('gel', 1, 20, 'Gel 1 - El Glaçal', 'un aliat silenciós.    '), -- Aquesta línia ha estat afegida per omplir a 20, ja que només n''hi havia 19 dades
-- Gel 2 - Mur de Gebrada (20 línies)
...
('gel', 3, 20, 'Gel 3 - Tundra', 'ncia.                  '); -- Aquesta línia ha estat afegida per omplir a 20, ja que només n''hi havia 19 dades

--
-- DADES DE LA CATEGORIA: aigua
--
INSERT INTO datos_ejemplo (categoria, mag, linea_orden, titol, linea_texto) VALUES
-- Aigua 1 - El Torrent (20 línies)
...
('aigua', 2, 20, 'Aigua 2 - La Mareia', 's enemics de la natura.'), -- Aquesta línia ha estat afegida per omplir a 20, ja que només n''hi havia 19 dades
-- Aigua 3 - Sirena (20 línies)
...
('selva', 1, 20, 'Selva 1 - El Druida', 'ut i indomable.        '), -- Aquesta línia ha estat afegida per omplir a 20, ja que només n''hi havia 19 dades
-- Selva 2 - El Verí (20 línies)
